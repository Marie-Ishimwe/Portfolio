...
const portfolioProjects = [
  {
    ...
    title: " Quizzle",
    results: [
      { title: "Puzzle-based learning application" },
      { title: "Designed to teach English common nouns" },
      { title: "Developed using Flutter and Firebase" },
    ],
  ...
  },
  {
    ...
    title: "Emolearn",
    results: [
      { title: "Emoji-based learning application" },
      { title: "Designed to teach English common nouns" },
      { title: "Developed using Flutter and Firebase" },
    ],
    ...
    <section id={id} className="pb-16 lg:py-24">
      <div className="container">
        <SectionHeader
          ...
          description="See how I transformed concepts into engaging digital expereinces."
        ></SectionHeader>
          ...
          {portfolioProjects.map((project, projectIndex) => (
            <Card
              ...
              text-sm text-transparent bg-clip-text"
                  ...
                  <ul className="flex flex-col mt-4 md:mt-5 gap-2">
