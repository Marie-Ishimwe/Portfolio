    ...
    <div className="container">
      <div className="bg-gradient-to-r from-emerald-300 to-sky-400 text-gray-900 py-8 px-10 rounded-3xl text-center relative overflow-hidden z-0">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center md:text-left">
          <div className="">
    <h2 className='font-serif text-2xl md:text-3xl'>Let us creat something amazing together</h2>
    <p className='text-sm mt-2 md:text-base'>Ready to bring your next project to life? Let us connect and discuss how I can help you achive your goals </p>
    </div>
    <div className="">
